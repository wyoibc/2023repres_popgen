...
Then, if we want to fully reset the main branch to that previous commit, we can use, again replacing `######` with the proper index of the commit you want to revert to:
